<!-- ========================= STUDENT GRADE MODAL =======================
<div id="addmodalexcel" class="modal fade">
<form method="post">
  <div class="modal-dialog modal-sm" style="width:300px !important;">
    <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            <h4 class="modal-title">Add Student Grade excel file</h4>
        </div>
         -->
		<!-- ========================= STUDENT GRADE MODAL ======================= -->
<div id="addmodalexcel" class="modal fade">
        ...
        <div class="modal-body">
            ...
            <div class="row">
                <div class="col-md-12">
					...
					<div class="form-group" >
                        <label>5th Grading:</label>
                        <input type="text" class="form-control input-sm" name="txt_5thgrading" placeholder="5th Grading"/>
                    </div>
					<div class="form-group" >
                        <label>6th Grading:</label>
                        <input type="text" class="form-control input-sm" name="txt_6thgrading" placeholder="6th Grading"/>
                    </div>
					<div class="form-group" >
                        <label>7th Grading:</label>
                        <input type="text" class="form-control input-sm" name="txt_7thgrading" placeholder="7th Grading"/>
                    </div>
					
					<div class="form-group" >
                        <label>8th Grading:</label>
                        <input type="text" class="form-control input-sm" name="txt_8thgrading" placeholder="8th Grading"/>
                    </div>
					<div class="form-group" >
                        <label>9th Grading:</label>
                        <input type="text" class="form-control input-sm" name="txt_9thgrading" placeholder="9th Grading"/>
                    </div>
					<div class="form-group" >
                        <label>10th Grading:</label>
                        <input type="text" class="form-control input-sm" name="txt_10thgrading" placeholder="10th Grading"/>
                    </div>
					<div class="form-group" >
                        <label>Exams Mark</label>
                        <input type="text" class="form-control input-sm" name="txt_ExamsMark" placeholder="Exams Mark"/>
                    </div>
                </div>
            </div>
