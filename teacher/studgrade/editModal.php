            ...
            <div class="col-md-12">
                ...
                <div class="form-group">
				 ...
				 <div class="form-group">
                    ...
                    <input name="txt_edit_5thgrading" id="txt_edit_5thgrading" class="form-control input-sm" type="number" value="'.$row['5thgrading'].'" />
                </div>
				 <div class="form-group">
                    <label>6th Grading: </label>
                    <input name="txt_edit_6thgrading" id="txt_edit_6thgrading" class="form-control input-sm" type="number" value="'.$row['6thgrading'].'" />
                </div>
				 <div class="form-group">
                    <label>7th Grading: </label>
                    <input name="txt_edit_7thgrading" id="txt_edit_7thgrading" class="form-control input-sm" type="number" value="'.$row['7thgrading'].'" />
                </div>
				 <div class="form-group">
                    <label>8th Grading: </label>
                    <input name="txt_edit_8thgrading" id="txt_edit_8thgrading" class="form-control input-sm" type="number" value="'.$row['8thgrading'].'" />
                </div>
				 <div class="form-group">
                    <label>9th Grading: </label>
                    <input name="txt_edit_9thgrading" id="txt_edit_9thgrading" class="form-control input-sm" type="number" value="'.$row['9thgrading'].'" />
                </div>
				 <div class="form-group">
                    <label>10th Grading: </label>
                    <input name="txt_edit_10thgrading" id="txt_edit_10thgrading" class="form-control input-sm" type="number" value="'.$row['10thgrading'].'" />
                </div>
            </div>
        </div>
        </div>
