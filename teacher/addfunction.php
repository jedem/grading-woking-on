...
<?php
	if(isset($_POST['btn_add_studgrade'])){
		...
		$txt_2ndgrading = $_POST['txt_2ndtgrading'];
		$txt_3rdgrading = $_POST['txt_3rdgrading'];
		$txt_4thgrading = $_POST['txt_4thgrading'];
		$txt_5thgrading = $_POST['txt_5thgrading'];
		$txt_6thgrading = $_POST['txt_6thgrading'];
		$txt_7thgrading = $_POST['txt_7thgrading'];
		$txt_8thgrading = $_POST['txt_8thgrading'];
		$txt_9thgrading = $_POST['txt_9thgrading'];
		$txt_10thgrading = $_POST['txt_10thgrading'];
		$txt_ExamsMark = $_POST['txt_ExamsMark'];
		...
		if($ct == 0)
		{
		$query = mysqli_query($con,"INSERT INTO tblstudentgrade (studentid,schoolyearid,subjectid,classid,adviserid,1stgrading,2ndgrading,3rdgrading,4thgrading,5thgrading,6thgrading,7thgrading,8thgrading,9thgrading,10thgrading,ExamsMark) values ('".$ddl_stud."','".$ddl_sy."','".$ddl_subj."','".$ddl_class."','".$_SESSION['userid']."','".$txt_1stgrading."','".$txt_2ndgrading."','".$txt_3rdgrading."','".$txt_4thgrading."','".$txt_5thgrading."','".$txt_6thgrading."','".$txt_7thgrading."','".$txt_8thgrading."','".$txt_9thgrading."','".$txt_10thgrading."','".$txt_ExamsMark."')") or die(mysqli_error($con)); 
																																			//$query = mysqli_query($con,"INSERT INTO tblstudentgrade (studentid,schoolyearid,subjectid,classid,adviserid,1stgrading) values ('".$ddl_stud."','".$ddl_sy."','".$ddl_subj."','".$ddl_class."','".$_SESSION['userid']."','".$txt_1stgrading."')") or die(mysqli_error($con)); ,'".$txt_1stgrading."'     $txt_Exams Mark
